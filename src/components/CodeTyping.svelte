<script>
  ...
  const codeContentArray = ["'hello world'", "'namaste'", "'Good Day !'"];
  let codeContent = "";
  let arrayIndex = 0;
  let charIndex = 0;
  const typeSpeed = 100;
...
<div class="flex flex-col justify-center space-y-8">
  ...
  <div class="flex flex-col rounded-xl bg-[#1e1e1e]">
    <!-- top bar of editor  -->
    <div
      class="flex flex-row bg-[#282828] space-x-4 py-3 px-4 justify-start items-center rounded-xl"
    >
      <!-- icons  -->
      ...
      <div class="text-gray-500 font-normal text-4xl px-12">+</div>
    </div>
  ...
  <div class="flex flex-col rounded-xl bg-neutral-800">
    <!-- top bar of editor  -->
    <div
      class="flex flex-row bg-neutral-900 justify-end space-x-4 py-4 px-4 rounded-xl"
    >
      <!-- icons  -->
      <div class="text-neutral-200 text-lg pr-60 font-medium">
